\begin{frame}
  ...
  \begin{columns}
    ...
    \centering
    \begin{tikzpicture}
      \node{\includegraphics[width=0.95\textwidth]{running-coupling.png}};
      \node[font=\tiny,align=left] at (0.2,1.5) {\href{https://journals.aps.org/prd/abstract/10.1103/PhysRevD.110.030001}{Phys. Rev. D 110, 030001}};
    \end{tikzpicture}
